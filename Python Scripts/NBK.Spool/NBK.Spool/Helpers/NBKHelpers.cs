...
namespace NBK.Spool
{
    public static class NBKHelpers
    {
        public static List<SpoolNumber> GetExistingSpoolNumbers(Document doc)
        {
            ...
            catFilters.Add(new ElementCategoryFilter(BuiltInCategory.OST_PipeAccessory));
        ...
        public static List<RevitElement> GetElementsFromReferences(Document doc, IList<Reference> selectedReferences)
        {
            ...
            foreach (Reference reference in selectedReferences)
            {
                ...
                RevitElement revitElement = RevitElementfromElement(doc, fabconfig, element);
        ...
        private static RevitElement RevitElementfromElement(Document doc, FabricationConfiguration fabconfig, Element element)
        {
            ...
            //familyTypeName = fabType.get_Parameter(BuiltInParameter.SYMBOL_NAME_PARAM).AsString();
            //familyName = fabType.get_Parameter(BuiltInParameter.SYMBOL_FAMILY_NAME_PARAM).AsString();

            // get the family type
            Element famType = doc.GetElement(element.GetTypeId());
            familyTypeName = famType.get_Parameter(BuiltInParameter.SYMBOL_NAME_PARAM).AsString();
            familyName = famType.get_Parameter(BuiltInParameter.SYMBOL_FAMILY_NAME_PARAM).AsString();
            ...
            // cast the element as a fabrication part
            ...
            if (fabPart != null)
            {
                ...
                if (fabPart.IsAStraight())
                {
                    ...
                    //Get the name of the connectors
